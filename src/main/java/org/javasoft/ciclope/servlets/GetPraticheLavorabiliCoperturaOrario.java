 ...
 * @author andrea
 */
@WebServlet(name = "GetPraticheLavorabiliCoperturaOrario", urlPatterns = {"/GetPraticheLavorabiliCoperturaOrario"})
public class GetPraticheLavorabiliCoperturaOrario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String selectedDate = maps.get("data_selezionata")[0];
            String operatorId = maps.get("id_operatore")[0];
